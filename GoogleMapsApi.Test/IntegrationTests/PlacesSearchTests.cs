...
namespace GoogleMapsApi.Test.IntegrationTests
{
    ...
    public class PlacesSearchTests : BaseTestIntegration
    {
        ...
        public async Task ReturnsNearbySearchRequest()
        {
            ...
            PlacesResponse result = await GoogleMaps.Places.QueryAsync(request, _httpClientService);
        ...
        public async Task TestNearbySearchPagination()
        {
            ...
            result = await GoogleMaps.Places.QueryAsync(request, _httpClientService);
